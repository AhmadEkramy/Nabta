                      ...
                      <div key={day} className="flex items-center space-x-3">
                        ...
                        <div className="flex-1 bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                          <div
                            ...
                            style={{
                              width: `${displayUser?.weeklyProgress?.[day.toLowerCase()]?.tasks || 0}%`
                            }}
                          ></div>
                        </div>
                        <span className="text-sm text-gray-500 w-8">
                          {displayUser?.weeklyProgress?.[day.toLowerCase()]?.tasksCount || 0}
                        </span>
                      </div>
                    ))}
                  </div>
                      ...
                      <div key={day} className="flex items-center space-x-3">
                        ...
                        <div className="flex-1 bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                          <div
                            ...
                            style={{
                              width: `${(displayUser?.weeklyProgress?.[day.toLowerCase()]?.focusHours || 0) * 20}%`
                            }}
                          ></div>
                        </div>
